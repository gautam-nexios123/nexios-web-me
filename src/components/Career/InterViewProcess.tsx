...
import perInterview from "../../assets/images/career/hr-interview.svg";
import hrInterviewPic from "../../assets/images/career/ic-hr-interview.p.png";
        ...
        <div className="relative">
          <div className="border-[8px] border-[#399EFD] rounded-full w-[140px] h-[140px] sm:w-[180px] sm:h-[180px] flex justify-center items-center">
            <Image
              src={hrInterviewPic}
              alt="hrInterviewPic"
              className="w-[100px] h-[100px] sm:w-[130px] sm:h-[130px] object-cover"
            />
          </div>
        </div>
